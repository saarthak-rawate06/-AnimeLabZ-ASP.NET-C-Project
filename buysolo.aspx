<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buysolo.aspx.cs" Inherits="AnimeX_Project.buysolo" %>
            ...
            <table class="auto-style3" border="1">
                <tr>
                    <td class="auto-style12">
                        ...
                        <img alt="" class="auto-style11" src="icons/solo%20leveling.jpg" style="padding-right: 5px" aria-grabbed="false"/>
                    </td>
                    <td class="auto-style13">
                        <table class="auto-style3" border="1">
                            ...
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label2" runat="server" ForeColor="#FFFFCC" Font-Size="15pt"> Solo Leveling manga depicts Jinwoo&#39;s journey from a weak hunter to a formidable force, empowered by a unique leveling system. He battles monstrous creatures to protect humanity, unveiling mysteries and gaining allies along the way.</asp:Label></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label11" runat="server" Text="Price: Rs.1500/-" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10">
