<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buyrefuse.aspx.cs" Inherits="AnimeX_Project.buyrefuse" %>
            ...
            <table class="auto-style3" border="1">
                <tr>
                    <td class="auto-style12">
                        ...
                        <img alt="" class="auto-style11" src="icons/i%20refuse%20the%20attachment%20of%20the%20emperor%20who%20abandoned%20me.jpg" style="padding-right: 5px" aria-grabbed="false"/>
                    </td>
                    <td class="auto-style13">
                        <table class="auto-style3" border="1">
                            <tr>
                                <td style="text-align:center" class="auto-style10">  <asp:Label ID="lbl1" runat="server" Text="Refuse the attachment" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label2" runat="server" ForeColor="#FFFFCC" Font-Size="15pt">        I Refuse the Attachment of the Emperor Who Abandoned Me manga centers on Lucia, betrayed by her husband, the emperor. Determined to forge her own destiny, she navigates court politics, seeking justice and reclaiming her power amidst adversity.</asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label3" runat="server" Text="Author: Eun-bi Park" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label4" runat="server" Text="Release: 2024" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label5" runat="server" Text="Chapters: 40" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label11" runat="server" Text="Price: Rs.450/-" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10">
