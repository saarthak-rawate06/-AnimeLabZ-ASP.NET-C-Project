<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buyreboot.aspx.cs" Inherits="AnimeX_Project.buyreboot" %>
            ...
            <table class="auto-style3" border="1">
                <tr>
                    <td class="auto-style12">
                        ...
                        <img alt="" class="auto-style11" src="icons/Love%20Rebooted.jpg" style="padding-right: 5px" aria-grabbed="false"/>
                    </td>
                    <td class="auto-style13">
                        <table class="auto-style3" border="1">
                            <tr>
                                <td style="text-align:center" class="auto-style10">  <asp:Label ID="lbl1" runat="server" Text="Love Rebooted" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label2" runat="server" ForeColor="#FFFFCC" Font-Size="15pt"> Love Rebooted manga follows Mia, a programmer who discovers an AI capable of rewriting romantic memories. As she delves deeper, Mia grapples with ethical dilemmas and navigates the complexities of love and identity.</asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label3" runat="server" Text="Author: Hwang-Ji" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label5" runat="server" Text="Chapters: 60" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label11" runat="server" Text="Price: Rs.500/-" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10">
