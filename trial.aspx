<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trial.aspx.cs" Inherits="AnimeX_Project.trial" %>
                     ...
                     <td>
                         <table class="auto-style9">
                             <tr>
                                 ...
                                 <td><asp:Label ID="lbluname" runat="server" Font-Bold="True" Font-Names="Bell MT" ForeColor="White" Font-Size="X-Large"></asp:Label>
                                 </td>
                             </tr>
                         </table>
                     </td>
                     <td style="text-align:center" class="auto-style7">
            <asp:Label ID="lblhome" runat="server" Font-Bold="True" Font-Names="Bell MT" Font-Size="40pt" ForeColor="white" Text="Home"></asp:Label>
                     </td>
             ...
             <asp:DropDownList ID="list" runat="server" BackColor="Black" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="#049B9F" Height="32px"  Width="190px" CssClass="auto-style8">
                           ...
                           <table style="padding: 8px; border-style: groove; border-width: 2px">
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <br />
                                       <br />
                                       &nbsp;<asp:Button ID="buybtn1" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="addcbtn" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
                                   </td>
                               </tr>
                           </table>
                       </td>
                           ...
                           <table style="padding: 8px; border-style: groove; border-width: 2px">
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        <br />
                                        <asp:Label ID="Label4" runat="server" ForeColor="#FFFFCC" Font-Size="15pt">
                                               Love Rebooted manga follows Mia, a programmer who discovers an AI capable of rewriting romantic memories. As she delves deeper, Mia grapples with ethical dilemmas and navigates the complexities of love and identity.
                                        </asp:Label>
                                        <br />
                                        <br />
                                       &nbsp;<asp:Button ID="buybtn2" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="addcbtn2" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
                                    </td>
                                </tr>
                            </table>
                       </td>
     ...
     <table style="padding: 8px; border-style: groove; border-width: 2px">
         <tr>
             ...
             <td>
                 ...
                 <br />
                 <br />
                 &nbsp;<asp:Button ID="buybtn3" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="addcbtn3" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
             </td>
         </tr>
     </table>
 </td>
     ...
     <table style="padding: 8px; border-style: groove; border-width: 2px">
         <tr>
              ...
              <td>
                  ...
                  <br />
                  <br />
                 &nbsp;<asp:Button ID="buybtn4" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="addcbtn4" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
              </td>
          </tr>
      </table>
 </td>
    ...
    <table style="padding: 8px; border-style: groove; border-width: 2px">
        <tr>
            ...
            <td>
                ...
                <br />
                <br />
                &nbsp;<asp:Button ID="buybtn5" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="addcbtn5" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
            </td>
        </tr>
    </table>
</td>
    ...
    <table style="padding: 8px; border-style: groove; border-width: 2px">
        <tr>
             ...
             <td>
                 ...
                 <br />
                 <br />
                &nbsp;<asp:Button ID="buybtn6" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="addcbtn6" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
             </td>
         </tr>
     </table>
</td>
    ...
    <table style="padding: 8px; border-style: groove; border-width: 2px">
        <tr>
            ...
            <td>
                ...
                <br />
                <br />
                &nbsp;<asp:Button ID="buybtn7" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="addbtn7" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
            </td>
        </tr>
    </table>
</td>
<td width="45%">
    <table style="padding: 8px; border-style: groove; border-width: 2px">
        <tr>
             <td>
                 <img alt="" class="ing" src="icons/overgeared-1.webp" style="padding-right: 5px"/>
             </td>
             <td>
                 <asp:Label ID="Label15" runat="server" Text="I Refuse The Attachment Of The Emperor Who Abandoned Me" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20"></asp:Label>
                 <br />
                 <asp:Label ID="Label16" runat="server" ForeColor="#FFFFCC" Font-Size="15pt">
                     I Refuse the Attachment of the Emperor Who Abandoned Me manga centers on Lucia, betrayed by her husband, the emperor. Determined to forge her own destiny, she navigates court politics, seeking justice and reclaiming her power amidst adversity.
                 </asp:Label>
                 <br />
                 <br />
                &nbsp;<asp:Button ID="Button3" runat="server" Text="Buy" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />&nbsp; <asp:Button ID="Button4" runat="server" Text="Add to cart" BackColor="#FFFF66" BorderColor="#333333" BorderStyle="Groove" BorderWidth="2px" Font-Bold="True" Font-Names="Bell MT" Font-Size="Medium" ForeColor="Black" />
             </td>
         </tr>
     </table>
</td>
