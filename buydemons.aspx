<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buydemons.aspx.cs" Inherits="AnimeX_Project.buydemons" %>
            ...
            <table class="auto-style3" border="1">
                <tr>
                    <td class="auto-style12">
                        ...
                        <img alt="" class="auto-style11" src="icons/the-chronicles-of-heavenly-demon.png" style="padding-right: 5px" aria-grabbed="false"/>
                    </td>
                    <td class="auto-style13">
                        <table class="auto-style3" border="1">
                            <tr>
                                <td style="text-align:center" class="auto-style10">  <asp:Label ID="lbl1" runat="server" Text="Chronicles Of Heavenly Demons" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label2" runat="server" ForeColor="#FFFFCC" Font-Size="15pt">                  The Chronicles of Heavenly Demon manga narrates the journey of Tian, a demon who seeks revenge against those who betrayed him. With ancient powers and allies, he embarks on a quest for vengeance, unraveling secrets of his past and destiny.</asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label3" runat="server" Text="Author: II-Hwang" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label5" runat="server" Text="Chapters: 250" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td></td>
                            </tr>
                            <tr>
                                <td class="auto-style10"> <asp:Label ID="Label11" runat="server" Text="Price: Rs.1800/-" ForeColor="#FFCCFF" Font-Bold="True" Font-Names="Bell MT" Font-Size="20pt"></asp:Label></td>
                            </tr>
                            <tr>
                                <td class="auto-style10">
